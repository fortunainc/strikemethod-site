...
Last reconciled: 2026-09-03 13:32 America/Los_Angeles
...
| Two-depth beta capture | Repair prepared at `4c815fa` | Live quick capture; qualified footer regressed | Live HTTP/source reconciliation | Quick signups operational; qualified evidence blocked until repair deploy | Quick capture only |
...
| Server-side acquisition analytics | Available in Netlify plan | No; disabled | Netlify project UI verified | Account activation pending | No conversion denominator yet |
...
Merge and deploy `4c815fa`, enable the included privacy-sensitive Netlify Web Analytics, verify both capture depths, then obtain authorized qualified Options traffic/interviews before the 30-day product clock completes.
